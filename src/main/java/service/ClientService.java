...
public class ClientService {
	...
	// edit client name
	public Client editClient(String clientid, AddOrEditClientDTO client)
	...
	public List<ClientWithAccount> clientWithAccount(String clientid)
			throws DatabaseException, BadParameterException, AccountNotFoundException {
